...
<Profile xmlns="http://soap.sforce.com/2006/04/metadata">
    ...
    <classAccesses>
        <apexClass>ApexExample</apexClass>
    ...
    <classAccesses>
        <apexClass>ShortApexExample</apexClass>
        <enabled>true</enabled>
    </classAccesses>
    <classAccesses>
        <apexClass>SimpleLoop</apexClass>
        <enabled>true</enabled>
    </classAccesses>
    <custom>false</custom>
    <fieldPermissions>
    ...
    <fieldPermissions>
        <editable>true</editable>
        <field>Lead.Seven_lead__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>true</editable>
    ...
    <layoutAssignments>
        <layout>Student__c-Non-Technical Layout</layout>
        <recordType>Student__c.Non_Technical</recordType>
    </layoutAssignments>
    <layoutAssignments>
        <layout>Student__c-Student Layout</layout>
    </layoutAssignments>
    <layoutAssignments>
        <layout>Student__c-Technical Layout</layout>
        <recordType>Student__c.Technical</recordType>
    </layoutAssignments>
    <layoutAssignments>
